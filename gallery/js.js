 ...
 * @property {string} settings.openedImageCloseBtnSrc Путь до картинки заглушки если не найдена картинка.
 */
const gallery = {
    settings: {
        ...
        previewImageNoPhoto: 'images/gallery/no_photo.png',
    },
    ...
    createScreenContainer() {
        ...
        image.onerror = () => image.src = this.settings.previewImageNoPhoto;
